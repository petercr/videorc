...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // No backdrop blur: see DialogContent's compositor-wedge note.
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // Glass panel (videorc-design): near-opaque popover surface with the
          // panel-tier radius and the layered shadow + hairline ring,
